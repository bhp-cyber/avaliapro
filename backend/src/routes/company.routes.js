...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name_1, domain, company, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, name_1 = _a.name, domain = _a.domain;
                if (!name_1) {
                    return [2 /*return*/, res.status(400).json({ error: "Nome da empresa é obrigatório" })];
                }
                return [4 /*yield*/, prisma_1.default.company.create({
                        data: {
                            name: name_1,
                            domain: domain,
            ...
            case 2:
                error_2 = _b.sent();
                console.error("Erro ao criar empresa:", error_2);
                return [2 /*return*/, res.status(500).json({ error: "Erro interno do servidor" })];
            case 3: return [2 /*return*/];
        }
    });
