...
router.get("/", function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Erro ao buscar reviews:", error_1);
...
router.post("/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, rating, title, comment, productId, companyId, customerId, review, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, rating = _a.rating, title = _a.title, comment = _a.comment, productId = _a.productId, companyId = _a.companyId, customerId = _a.customerId;
            ...
            case 1:
                review = _b.sent();
                return [2 /*return*/, res.status(201).json(review)];
            case 2:
                error_2 = _b.sent();
                console.error("Erro ao criar review:", error_2);
                return [2 /*return*/, res.status(500).json({ error: "Erro interno do servidor" })];
            case 3: return [2 /*return*/];
        }
    });
